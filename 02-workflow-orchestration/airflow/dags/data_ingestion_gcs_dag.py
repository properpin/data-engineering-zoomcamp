...
import pendulum # import pendulum for timezone support and replace days_ago
...
def format_to_parquet(src_file):
    ...
    if src_file.endswith('.csv'):
        out_file = src_file.replace('.csv', '.parquet')
    else:
        out_file = src_file.replace('.csv.gz', '.parquet')
...
with DAG(
    ...
    download_dataset_task >> format_to_parquet_task >> local_to_gcs_task >> create_bq_dataset_task >> bigquery_external_table_task
